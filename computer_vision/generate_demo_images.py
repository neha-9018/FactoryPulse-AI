...
DEMO_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "backend", "datasets", "demo_images")
...
def generate_demo_parts():
    ...
    print("[SUCCESS] Saved healthy_part.png")
    ...
    print("[SUCCESS] Saved label_missing.png")
    ...
    print("[SUCCESS] Saved surface_crack.png")
    ...
    print("[SUCCESS] Saved wrong_color.png")
    ...
    print("[SUCCESS] Saved wrong_dimension.png")
